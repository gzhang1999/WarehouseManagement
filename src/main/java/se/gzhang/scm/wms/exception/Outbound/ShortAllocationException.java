...
public class ShortAllocationException extends StandProductException {
    ...
    public ShortAllocationException(ShortAllocationExceptionType shortAllocationExceptionType,  String message) {
        super("ShortAllocationException." + shortAllocationExceptionType.name(), message);
    }
}
