...
@Repository
public interface LocationGroupRepository extends JpaRepository<LocationGroup, Integer>, JpaSpecificationExecutor<LocationGroup> {
    List<LocationGroup> findAll();

    LocationGroup findById(int id);
