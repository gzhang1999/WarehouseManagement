...
public class EmptyLocationAllocationStrategy extends DefaultAllocationStrategy {

    public EmptyLocationAllocationStrategy(InventoryService inventoryService,
