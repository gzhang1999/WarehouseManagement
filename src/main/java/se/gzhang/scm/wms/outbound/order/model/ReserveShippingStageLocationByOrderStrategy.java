...
public class ReserveShippingStageLocationByOrderStrategy extends DefaultShippingStageLocationReserveStrategy {

    public ReserveShippingStageLocationByOrderStrategy(LocationService locationService, SalesOrderService salesOrderService) {
    ...
    public void reserve(Location location, SalesOrder salesOrder){
        if (isReservable(location, salesOrder)) {
            locationService.reserveLocation(location, salesOrder.getNumber(),
    ...
    public boolean isReservable(Location location, SalesOrder salesOrder) {
        ...
        if ((location.getReserveCode() == null || location.getReserveCode().isEmpty() || location.getReserveCode().equals(salesOrder.getNumber()))
