...
public class ReceiptLineSerializer extends StdSerializer<ReceiptLine> {

        public ReceiptLineSerializer() {
            this(null);
        }

        public ReceiptLineSerializer(Class<ReceiptLine> receiptLine) {
            super(receiptLine);
        }

        @Override
        public void serialize(
                ReceiptLine receiptLine, JsonGenerator jgen, SerializerProvider provider)
        ...
        if (receiptLine.getReceipt() != null) {
            Receipt receipt = receiptLine.getReceipt();
